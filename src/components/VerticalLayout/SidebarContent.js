          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/Sales">{props.t("Sale")}</Link>
                </li>
                <li>
                  <Link to="/Sales-mc">{props.t("Sales Motorcycle")}</Link>
                </li>
                <li>
                  <Link to="/Sales-auto">{props.t("Sales Auto")}</Link>
                </li>
                <li>
                  <Link to="/Sales-bty">{props.t("Sale Battery")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/email-inbox">{props.t("Sales Reports")}</Link>
                </li>
                <li>
                  <Link to="/email-read">{props.t("Stock Reports")} </Link>
                </li>
                <li>
                  <Link to="/email-compose">
                    {props.t("Customer Reports")}{" "}
                  </Link>
                </li>
              </ul>
            </li>
