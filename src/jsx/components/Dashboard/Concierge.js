            ...
            <div className="d-flex mb-4 justify-content-between align-items-center flex-wrap">
              <div className="card-tabs mt-3 mt-sm-0 mb-xxl-0 mb-4">
                <Nav as="ul" className="nav nav-tabs">
                  ...
                  <Nav.Item as="li" className="nav-item">
                    <Nav.Link className="nav-link" eventKey="Inactive">
                      Inactive
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li" className="nav-item">
                    <Nav.Link className="nav-link" eventKey="Active">
                      Active
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
                      ...
                      <tbody>
                          ...
                          <td className="job-desk">
                            <div>
                              <span className="fs-16">
                                Act as a liaison between guests and any
                                department necessary including the kitchen,
                                housekeeping, etc
                              </span>
                            </div>
                          </td>
                        ...
                        <tr role="row" className="even">
                          ...
                          <td className="job-desk">
                            <div>
                              <span className="fs-16">
                                Answering guest inquiries, directing phone
                                calls, coordinating travel plans, and more.
                              </span>
                            </div>
                          </td>
                          <td>
